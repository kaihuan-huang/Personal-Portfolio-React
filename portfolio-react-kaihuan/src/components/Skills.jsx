...
const Skills = () => {
  ...
  return (
    <div name='skills' className='section-bg-gradient w-full min-h-screen bg-gradient-to-b from-[#8892b0] to-[#0a192f] text-gray-300 py-16 transition-colors duration-300'>
      {/* Container */}
